                ...
                <div className="mt-6 flex flex-col gap-3 border-t border-subtle pt-5">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-tertiary">
                            Download a file with all database data (projects, issues, columns, categories, members, and users), useful for restoring the
                            platform if the database needs to be recreated from scratch.
                        </p>
                    </div>
